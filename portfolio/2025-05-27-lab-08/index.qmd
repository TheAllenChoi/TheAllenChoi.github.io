...
text_page_helper <- function(page, css_selector) {
...
scrape_page <- function(cheese_url) {
    ...
    milk_info <- text_page_helper(page, ".summary_milk p")
    country_of_origin <- text_page_helper(page, ".summary_country p")
    family <- text_page_helper(page, ".summary_family p")
    type <- text_page_helper(page, ".summary_moisture_and_type p")
    flavour <- text_page_helper(page, ".summary_taste p")
